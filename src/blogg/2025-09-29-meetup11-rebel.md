...
Vi har fått låne [Exposalen](https://www.rebel.no/konferansesenter/konferanselokaler/exposalen) på Rebel, rett ved den store trappen i Expo-området.

Har du spørsmål? Ta gjerne kontakt i [#meetup](https://security-champions-no.slack.com/archives/C03L10QTFHP)-kanalen på <a href="{{ site.slackInvitationUrl }}">Slacken</a> vår!

### Program

🍕 Pizza serveres fra kl. **17.00**, og programmet starter ca. **17.15**:
...
**Takk til [Kodeklang](https://www.kodeklang.no) som sponser 🍕, og [Rebel](https://www.rebel.no/) for lokalet ❤️**
